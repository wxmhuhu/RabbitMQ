...
namespace MicroServices.Application.Services.Bom
{
    public class BomService : IBomService
    {
        ...
        public BomService(IBomRepository bomRepository,IProductRepository productRepository,IProcessRouteRepository processRouteRepository,IUniteRepository uniteRepository,IMapper mapper)
        {
        ...
        public async Task<ApiResult<ApiPaging<List<BomDto>>>> GetBomAsync(Models.Dtos.Bom.Search search)
        {
            try
            {
                ...
                var pagedData = await bominfo.OrderByDescending(d => d.Id) // 假设 Production_Planning 有 CreatedAt 属性
