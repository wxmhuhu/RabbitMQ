...
namespace MicroServices.Models.Dtos.Reportworks
{
    ...
    /// 检测项目显示DTO
    /// </summary>
    public class InspectionItemDisplayDto : AuditableEntity
    {
        /// <summary>
        /// 检测项目名称
        /// </summary>
        ...
        /// 报工质检ID
        /// </summary>
        public int ReportworkQualityInspectionId { get; set; }

        /// <summary>
        /// 报工质检名称
        /// </summary>
        public string ReportworkQualityInspectionName { get; set; }
    }
} 